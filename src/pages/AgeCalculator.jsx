...
const AgeCalculator = () => {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-6">
            <SEO
                title="만 나이 계산기 | 생년월일로 만 나이·한국 나이 즉시 계산"
                description="생년월일을 입력하면 만 나이와 한국 나이(세는 나이)를 즉시 계산합니다. 2023년 6월부터 한국 공식 나이는 만 나이입니다. 다음 생일 D-day와 살아온 날수도 확인하세요."
                keywords="만나이계산기, 한국나이계산, 만나이통일법, 생년월일나이계산, 나이계산기, 만나이변환, 생일D-day"
            />
            ...
            <ToolGuide
                title="만 나이 계산기 사용 가이드"
                intro="2023년 6월 28일부터 대한민국에서 공식적으로 만 나이를 사용합니다. 이 계산기는 생년월일을 입력하면 만 나이(법적 나이), 한국 나이(세는 나이), 다음 생일까지 남은 일수, 살아온 날수를 즉시 계산합니다."
                steps={[
