...
const AdditionQuiz = () => {
    ...
    const [history, setHistory] = useState([]); // { eq: string, answer: string, correct: boolean }
    ...
    const generateQuestions = (lvl, count) => {
        ...
        for (let i = 0; i < count; i++) {
            ...
            if (lvl === 1) {
                ...
                b = Math.floor(Math.random() * 9) + 1;
                // Randomly swap a and b for variety (e.g. 5 + 12 vs 12 + 5)
    ...
    return (
        <div className="max-w-md mx-auto px-4 py-8">
            ...
            <div className="text-center mb-6">
                ...
                <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">간단 덧셈 퀴즈</h1>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden min-h-[500px] flex flex-col">
                {gameState === 'menu' && (
                    <div className="p-8 flex flex-col items-center justify-center flex-1 space-y-6">
                        ...
                        <button
                            onClick={startGame}
                            className="w-full py-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-xl font-bold rounded-xl shadow-lg hover:shadow-xl transform active:scale-95 transition-all mt-4"
                        >
                            시작하기
                        </button>
                    </div>
                    ...
                    <div className="flex flex-col h-full">
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center p-6 space-y-8">
                            ...
                            <div className={`w-48 h-20 flex items-center justify-center text-4xl font-bold bg-gray-100 dark:bg-gray-700 rounded-2xl border-2 ${feedback
                                    ...
                                    : 'border-blue-200 dark:border-gray-600 text-gray-800 dark:text-white'
                                }`}>
                                {userAnswer || "?"}
                            </div>
                        ...
                        <div className="p-4 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700">
                            <button
                                ...
                                disabled={!userAnswer}
                                className="w-full h-14 bg-blue-600 hover:bg-blue-700 text-white text-xl font-bold rounded-xl shadow-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                            >
                                정답 확인 <Check size={24} />
                            </button>
                        </div>
