    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            <SEO
                ...
                description="섭씨(℃), 화씨(℉), 켈빈(K) 온도를 실시간으로 변환하세요. 미국 날씨 화씨 변환, 해외 레시피 오븐 온도 변환, 체온 비교 등에 활용하세요."
                keywords="온도변환기, 섭씨화씨변환, 켈빈변환, 화씨섭씨계산, 온도계산기, 미국온도변환, celsius fahrenheit kelvin"
                faqs={faqs}
            />
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                    섭씨(°C) · 화씨(°F) · 켈빈(K) — 세 가지 온도 단위를 동시에 실시간 변환하세요.
                </p>
            </div>
            ...
            <ToolGuide
                title="온도 변환기 사용 가이드"
                intro="온도 변환기는 전 세계에서 사용되는 세 가지 온도 스케일 — 섭씨(Celsius, °C), 화씨(Fahrenheit, °F), 켈빈(Kelvin, K) — 을 실시간으로 동시에 변환해줍니다. 하나의 입력란에 값을 입력하면 나머지 두 단위로 자동 변환되어 표시됩니다."
                steps={[
