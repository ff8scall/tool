...
const Base64Tool = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            <SEO
                title="Base64 인코더/디코더 | 온라인 텍스트 변환 도구"
                description="텍스트를 Base64 포맷으로 안전하게 인코딩하거나, Base64 문자열을 원본 텍스트로 디코딩하세요. 한글 완벽 지원 및 실시간 변환 기능을 제공하는 무료 개발자 도구입니다."
                keywords="base64인코더, base64디코더, base64변환기, 온라인인코딩, 온라인디코딩, 개발자도구, 텍스트인코딩"
                category="dev"
                faqs={toolFaqs}
                steps={toolSteps}
            />
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-gray-600 dark:text-gray-400 text-lg">
                    데이터 전송을 위한 표준 인코딩, 빠르고 안전하게 변환하세요.
                </p>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-3xl p-6 mb-10 flex items-start gap-4 border border-blue-100 dark:border-blue-900/30">
                ...
                <div>
                    <h4 className="font-black text-blue-900 dark:text-blue-300 mb-1">데이터 보안 안내</h4>
            ...
            <ToolGuide
                title="Base64 변환 완벽 가이드"
                intro="Base64는 데이터를 안전하게 전송하거나 임베딩하기 위해 가장 널리 쓰이는 표준 인코딩 방식입니다. 본 도구는 다양한 문자셋을 지원하며, 특히 다국어 처리에 특화되어 있어 개발 및 문서 작업의 효율성을 극대화합니다."
                steps={toolSteps}
                tips={toolTips}
                faqs={toolFaqs}
            />
